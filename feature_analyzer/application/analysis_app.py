...
from feature_analyzer.builder import EvaluatorBuilder

from feature_analyzer.data_tools.embedding_container import EmbeddingContainer
from feature_analyzer.utils.switcher import switch

# should cooperate add_container
from feature_analyzer.utils.report_writer import ReportWriter

from feature_analyzer.core.standard_fields import ApplicationStatusStandardFields as status_fields
from feature_analyzer.core.standard_fields import EvaluationStandardFields as metric_fields
from feature_analyzer.core.standard_fields import ConfigStandardFields as config_fields

from feature_analyzer.core.registered import EVALUATION_DISPLAY_NAMES as display_namemap

import argparse

parser = argparse.ArgumentParser('Command-line Analysis Tool')
